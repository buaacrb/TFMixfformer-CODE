...
class AutoCorrelation(nn.Module):
    """
    Correlation Mechanism with the following two phases:
    ...
    def forward(self, queries_tf, queries, keys, values, attn_mask):
...
class AutoCorrelationLayer(nn.Module):
    ...
    def forward(self, queries_tf, queries, keys, values, attn_mask):
        ...
        queries_tf = self.query_projection(queries_tf).view(B, L, H, -1)
